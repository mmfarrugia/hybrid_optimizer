...
from hybrid_optimizer import HO
...
def test_init():
    ho = HO(example_funcs.sq_obj_func, n_dim=3, constraint_eq=example_funcs.constraing_eq, constraint_ueq=example_funcs.constraint_ueq, dim=3)
    ho.X
    ho.de
    ho.pso
    print()
...
def test_initialIn():
    ho = HO(example_funcs.sq_obj_func, n_dim=3, constraint_eq=example_funcs.constraing_eq, constraint_ueq=example_funcs.constraint_ueq, dim=3, initial_points=ip_example)
    ho.X
    num_within = 0
    num_outside = 0
    for coord in ho.X:
